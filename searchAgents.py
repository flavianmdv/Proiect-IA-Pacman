...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state: Any):
        ...
        startState = state[0]
        visited = state[1]
        if startState in self.corners:
            if startState not in visited:
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[next_x][next_y]:
                ...
                cost = 1
                successors.append(((next_state, successorVisitedCorners), action, cost))
...
#     """
    ...
    while unvisitedCorners:
        ...
        for corner in unvisitedCorners:
            distance = util.manhattanDistance(startState, corner)
            distances.append((distance, corner))
        minDist, nextCorner = min(distances)
        unvisitedCorners.remove(nextCorner)
        startState = nextCorner
        totalCost += minDist
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState: pacman.GameState):
        ...
        "*** YOUR CODE HERE ***"
        # return search.ucs(problem) // ambele returneaza acelasi rezultat, adica trec testele
